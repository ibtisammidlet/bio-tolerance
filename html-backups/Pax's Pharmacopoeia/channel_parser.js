...
for (let i = 0; i < directoriesArray.length; i++) {
  console.log(`<li class="containerDefault-YUSmu3 selected-2TbFuo" data-dnd-name="casual" draggable="true">
<div class="iconVisibility-vptxma wrapper-NhbLHG modeSelected-3DmyhH">
<div class="content-1gYQeQ"><a href="./`
+directoriesArray[i]+
`.html" role="link" class="mainContent-20q_Hp" data-list-item-id="channels___1001422942380511286" tabindex="-1" aria-label="unread, casual (text channel)">
...
<div class="channelName-3KPsGw">`
+directoriesArray[i].slice(19, )+
`</div>
</div>
</a>
