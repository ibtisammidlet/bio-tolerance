...
/* Client Variables */
const client_id = '1001496087888142396'; // Paste your bot's ID here
const client_secret = 'yWQRZLMgyuMIqZJoWwdXmo40SKTntzNv'; // Paste your bot's secret here
...
/** editioal commet: here the info sent to the web page because web page did get request to the server side post reciver, which he did the acctual work of getting needed info
**/
...
console.log(data_1)
    ...
    axios.get("https://discord.com/api/users/@me", make_config(data.access_token)).then(response => { // Make a request yet again to the Discord API with the token from previously.
			...
			']'
			); // Send the username with a status code 200.
