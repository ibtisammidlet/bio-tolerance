...
router.get("/", (0, api_1.route)({}), async (req, res) => {
    ...
    if (!guild.widget_enabled)
        throw new util_1.HTTPError("Unknown Guild", 404);
    ...
    if (!["shield", "banner1", "banner2", "banner3", "banner4"].includes(style)) {
        throw new util_1.HTTPError("Value must be one of ('shield', 'banner1', 'banner2', 'banner3', 'banner4').", 400);
    }
    ...
    if (!fs_1.default.existsSync(source)) {
        throw new util_1.HTTPError("Widget template does not exist.", 400);
    }
